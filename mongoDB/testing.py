...
import random
uri = "mongodb+srv://trevorboultwood:0gdZWu6kqk9oyzf5@cluster0.1wniszp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
def generate_test_data(collection):
    # Generate 100 time and value entries
    for _ in range(500):
        timestamp = datetime.utcnow() - timedelta(minutes=random.randint(1, 500) * 15)
