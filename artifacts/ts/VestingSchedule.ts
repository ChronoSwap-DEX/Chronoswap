...
import { default as VestingScheduleContractJson } from "../chronex/VestingSchedule.ral.json";
...
> {
  getInitialFieldsWithDefaultValues() {
    return this.contract.getInitialFieldsWithDefaultValues() as VestingScheduleTypes.Fields;
  }
