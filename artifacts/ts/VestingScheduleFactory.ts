...
import { default as VestingScheduleFactoryContractJson } from "../chronex/VestingScheduleFactory.ral.json";
...
> {
  getInitialFieldsWithDefaultValues() {
    return this.contract.getInitialFieldsWithDefaultValues() as VestingScheduleFactoryTypes.Fields;
  }

  eventIndex = { VestingScheduleCreated: 0 };
  consts = {
...
export class VestingScheduleFactoryInstance extends ContractInstance {
  ...
  subscribeVestingScheduleCreatedEvent(
    options: EventSubscribeOptions<VestingScheduleFactoryTypes.VestingScheduleCreatedEvent>,
    fromCount?: number
  ): EventSubscription {
