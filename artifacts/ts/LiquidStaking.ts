...
import { default as LiquidStakingContractJson } from "../chronex/LiquidStaking.ral.json";
...
> {
  getInitialFieldsWithDefaultValues() {
    return this.contract.getInitialFieldsWithDefaultValues() as LiquidStakingTypes.Fields;
  }
