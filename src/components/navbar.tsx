...
export const CustomNavbar: React.FC = () => {
  ...
  return (
    <div className='flex items-center'>
      ...
      <div className='flex items-center'>
        <Image src="/images/ChronoSwapLogo_NoText_NoWhite.png" className="m-4" width={40} height={40} alt="ChronoSwap Logo" quality={100}/>
        <span className="text-xl font-medium tracking-wider ml-4">
          ChronoSwap
        </span>
      </div>
      <NavigationMenu>
      ...
      <div className="absolute right-2 flex items-right space-x-4">
